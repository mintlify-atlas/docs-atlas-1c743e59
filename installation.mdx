---
title: "Installation"
description: "Install Cardinal using Cargo, pip, or npm"
---
...
# Prepare data
prepare = ocdscardinal.Prepare()
# ... (API documentation coming soon)

# Calculate indicators
indicators = ocdscardinal.Indicators()
# ... (API documentation coming soon)
```

<Info>
  Detailed Python API documentation is coming soon. For now, refer to the CLI documentation and adapt commands to Python function calls.
</Info>
